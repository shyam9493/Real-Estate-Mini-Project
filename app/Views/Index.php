        ...
        <div class="mt-5">
            <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3  ">
                <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
                    <h1 class="display-4 fw-bold lh-1 text-body-emphasis">Homes that suit your lifestyle, neighborhoods
                        that match your vibe.
                    </h1>
                    <p class="lead">Whether you're buying your first home, searching for your next investment property,
                        or looking to rent a cozy apartment — we've got you covered.

                        With a wide selection of verified listings, expert agents, and tools to help you make smart
                        decisions, we make the home search simple and stress-free.

                        From luxury villas to budget-friendly flats, from peaceful suburbs to bustling city centers — we
                        help you discover places that feel just right.
